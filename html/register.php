    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="admin_login.php" method="post">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="email" id="inputEmail" class="form-control" name="Email_id" placeholder="Email address" required="required">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" id="confirmPassword" class="form-control" placeholder="Confirm password" name="conform_password" required="required">
        ...
        <div class="text-center">
          <a class="d-block small mt-3" href="login-admin.php">Login Page</a>
