...
<body id="product-page">
    ...
    <!--END OF NAVBAR--> 
     ...
     <div id="side-nav" class="side-nav-bar wow animated fadeIn">
        ...
        <a href="./product-rabi.php" class="rabi btn-green btn-product">Rabi</a>
    </div>
     <!--END OF SIDE NAVBAR--> 
        ...
        <div class="container">
            <div class="product-cover">
                ...
                <div class="wow animated fadeIn">
                    <a href="./product-kharif-1.php" class="next-btn btn-general btn-green"><i class="fa fa-angle-double-right"></i></a>
                </div>
            </div>
        </div>
    </section>
