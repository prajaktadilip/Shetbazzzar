            ...
            <div class="product-cover">
                <article class="card wow animated fadeIn">
                    ...
                    <h3 class="heading">
                        ...
                        <br><br>
                        <a href="./transaction.php" class="btn-blue">Buy Product</a>
                    </h3>
                    <p class="content">
                ...
                <div class="wow animated fadeIn">
                    <a href="./product-rabi.php" class="previous-btn btn-general btn-green"><i class=" fa fa-angle-double-left"></i></a>
                    <a href="./product-rabi-2.php" class="next-btn btn-general btn-green"><i class="fa fa-angle-double-right"></i></a>
                </div>
            </div>
        </div>
    </section>
