...
<!--                    <a href="" class="btn-general btn-green">Buy</a>-->
                ...
                <div class="wow animated fadeIn">
                    <a href="./product-kharif.php" class="previous-btn btn-general btn-green"><i class=" fa fa-angle-double-left"></i></a>
                    <a href="./product-kharif-2.php" class="next-btn btn-general btn-green"><i class="fa fa-angle-double-right"></i></a>
                </div>
            </div>
        </div>
    </section>
