...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT `user`.username,`user`.name,`user`.email,`user`.role,`assign_order`.`name1`,`assign_order`.`email1`,`assign_order`.`phoneno` ,`assign_order`.`quntity`,`assign_order`.`pname` FROM user inner join assign_order  on `user`.username =assign_order.username AND ";
            ...
            <div class="profile-home-content-inner-box">
                <div class="container">
                    ...
                    <div class="left-info">
                        ...
                        <div class="profile-home-heading">
                            <h5 class="text-heading">order details</h5>
                            <div class="content-title-underline"></div>
                            <!--.content-title-underline-->
                        </div><!--.profile-home-heading-->
                        <p class="about-info">name of farmer: <?php echo $_SESSION['name1'];?></p>
                        <p class="about-info">email: <?php echo $_SESSION['email1'];?></p>
                        <p class="about-info">phoneno: <?php echo $_SESSION['phoneno'];?></p>

                        <p class="about-info">pname: <?php echo $_SESSION['pname'];?></p>
                        <p class="about-info">required quantity: <?php echo $_SESSION['quntity'];?></p>
